...
export const TEMPLATES: Template[] = [
  ...
  // ─── 5. Serverless ───
  {
    ...
    edges: [
      ...
      { id: 't5-e5', source: 't5-3', target: 't5-6', type: 'system', data: { edgeType: 'db-query', label: '' } },
      { id: 't5-e6', source: 't5-4', target: 't5-6', type: 'system', data: { edgeType: 'db-query', label: '' } },
      { id: 't5-e7', source: 't5-5', target: 't5-7', type: 'system', data: { edgeType: 'rest', label: '' } },
    ],
  },
  ...
  // ─── 6. Data Pipeline ───
  {
    ...
    edges: [
      ...
      { id: 't6-e8', source: 't6-5', target: 't6-9', sourceHandle: 'right', targetHandle: 'left', type: 'system', data: { edgeType: 'tcp', label: '' } },
    ],
  },
  ...
  // ─── 7. Real-time Analytics ───
  {
    ...
    edges: [
      ...
      { id: 't7-e3', source: 't7-3', target: 't7-4', sourceHandle: 'right', targetHandle: 'left', type: 'system', data: { edgeType: 'tcp', label: '' } },
      { id: 't7-e4', source: 't7-3', target: 't7-5', type: 'system', data: { edgeType: 'pub-sub', label: 'Events' } },
      { id: 't7-e5', source: 't7-5', target: 't7-6', type: 'system', data: { edgeType: 'pub-sub', label: '' } },
      { id: 't7-e6', source: 't7-5', target: 't7-7', type: 'system', data: { edgeType: 'pub-sub', label: '' } },
      { id: 't7-e7', source: 't7-6', target: 't7-8', type: 'system', data: { edgeType: 'db-query', label: '' } },
      { id: 't7-e8', source: 't7-7', target: 't7-9', type: 'system', data: { edgeType: 'tcp', label: 'Metrics' } },
    ],
  },
  ...
  // ─── 8. Serverless Fullstack ───
  {
    ...
    edges: [
      ...
      { id: 't8-e5', source: 't8-4', target: 't8-6', type: 'system', data: { edgeType: 'db-query', label: '' } },
      { id: 't8-e6', source: 't8-5', target: 't8-8', sourceHandle: 'right', targetHandle: 'left', type: 'system', data: { edgeType: 'rest', label: '' } },
      { id: 't8-e7', source: 't8-5', target: 't8-7', type: 'system', data: { edgeType: 'pub-sub', label: '' } },
      { id: 't8-e8', source: 't8-7', target: 't8-9', type: 'system', data: { edgeType: 'pub-sub', label: '' } },
      { id: 't8-e9', source: 't8-9', target: 't8-10', type: 'system', data: { edgeType: 'tcp', label: 'Logs' } },
    ],
  },
  ...
  // ─── 9. Kubernetes Platform ───
  {
    ...
    edges: [
      ...
      { id: 't9-e3', source: 't9-3', target: 't9-4', sourceHandle: 'right', targetHandle: 'left', type: 'system', data: { edgeType: 'tcp', label: 'Metrics' } },
      { id: 't9-e4', source: 't9-3', target: 't9-5', type: 'system', data: { edgeType: 'grpc', label: '' } },
      { id: 't9-e5', source: 't9-3', target: 't9-6', type: 'system', data: { edgeType: 'grpc', label: '' } },
      { id: 't9-e6', source: 't9-4', target: 't9-7', type: 'system', data: { edgeType: 'tcp', label: 'Logs' } },
      { id: 't9-e7', source: 't9-5', target: 't9-8', type: 'system', data: { edgeType: 'db-query', label: '' } },
      { id: 't9-e8', source: 't9-6', target: 't9-9', type: 'system', data: { edgeType: 'pub-sub', label: '' } },
    ],
  },
];
